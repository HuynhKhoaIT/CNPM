												...
												<tr>
													...
													<c:forEach items="${listTrangThai}" var="tt">
														<c:if test="${tt.maTrangThai == list[i].getMaTrangThai()}">
															...
															<td><span class="badge badge-success" style="background : black">${tt.tenTrangThai}</span></td>
															</c:if>
															<c:if test="${list[i].getMaTrangThai() == 3}">
															<td><span class="badge badge-success" style="background : blue">${tt.tenTrangThai}</span></td>
															</c:if>
															<c:if test="${list[i].getMaTrangThai() == 4}">
															<td><span class="badge badge-success" style="background : red">${tt.tenTrangThai}</span></td>
															</c:if>
														</c:if>
