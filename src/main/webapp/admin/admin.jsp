				...
				<div class="row">
					...
					<div class="col-lg-6 col-6">
						...
						<div class="small-box bg-warning">
							...
							<a href="http://localhost:8080/Apple_store/admin/Ad_UserControl?u=2" class="small-box-footer">Thêm
								...
								<div class="row">
									<div class="col-sm-4 col-6">
										<div class="description-block border-right">
											...
											<h5 class="description-header">${total} VND</h5>
									...
									<div class="col-sm-4 col-6">
										<div class="description-block border-right">
											...
											<h5 class="description-header">${totalChiPhi} VND</h5>
									...
									<div class="col-sm-4 col-6">
										<div class="description-block border-right">
											...
											<h5 class="description-header">${total - totalChiPhi} VND</h5>
							...
							<div class="table-responsive">
								<table class="table m-0">
									...
									<c:forEach var="i" begin="0" end="${size-1 }">
										<tr>
											<td><a href="admin/Ad_invoiceControl?maDH=${list[i].getMaDH()}">${list[i].getMaDH()}</a></td>
											<td>${listName[i]}</td>
											<c:choose>
