...
@WebServlet("/admin/SellMonthly")
public class Ad_SellMonthly extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/admin/SellMonthly.jsp").forward(request, response);
    }
